...
This talk introduces **[Broad Listening](https://www.agoracitizen.network/resources/broadcasting-to-broadlistening)** as a way to move from shared attention to shared decisions.
...
- [**Decentralized Deliberation Standard**](https://dds.xyz): an initiative building an ecosystem of interoperable civic tech tools sharing verifiable collective intelligence data.
...
[Watch on YouTube](https://www.youtube.com/watch?v=FHpcdHiyCXw)
...
Agora is based on decentralized identifiers, or DIDs. It is fully compatible with zero-knowledge proofs, or ZKPs. For now, we are compatible with [Zupass](https://zupass.org/) and [ZK Passport](https://rarimo.com/) developed by the Rarimo team behind the Freedom Tool.
...
This is also why we launched the [DDS initiative](https://dds.xyz/) to build a **Decentralized Deliberation Standard** that enables an ecosystem of interoperable collective intelligence tools.
