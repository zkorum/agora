...
Cette présentation introduit le **[Broad Listening](https://www.agoracitizen.network/resources/broadcasting-to-broadlistening)** comme une manière de passer de l'attention partagée aux décisions partagées.
...
Agora repose sur des identifiants décentralisés, ou DID. Il est pleinement compatible avec les preuves à divulgation nulle de connaissance, ou ZKP. Pour l'instant, nous sommes compatibles avec [Zupass](https://zupass.org/) et [ZK Passport](https://rarimo.com/), développé par l'équipe Rarimo derrière Freedom Tool.
...
C'est aussi pourquoi nous avons lancé l'[initiative DDS](https://dds.xyz/) pour construire un **Decentralized Deliberation Standard**, qui permet un écosystème d'outils d'intelligence collective interopérables.
...
**Mots-clés :** Agora Citizen Network, ETHPrague, Broad Listening, Active Listening, Passive Listening, intelligence collective, échecs de coordination, délibération numérique, cartographie des opinions, consensus à travers les différences, Plural Voting, Decentralized Deliberation Standard, DDS, preuves à divulgation nulle de connaissance, identifiants décentralisés, Zupass, ZK Passport, civic tech, DAO, network states, gouvernance de l'IA.
