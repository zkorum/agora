...
- [**d/acc**](https://vitalik.eth.limo/general/2025/01/05/dacc2.html): aceleración diferencial defensiva, descentralizada y democrática.
...
Por otro lado, existen herramientas de deliberación como [Polis](https://pol.is/), Remesh y otras, que los gobiernos usan en consultas públicas y asambleas ciudadanas. Pero están construidas desde un enfoque de arriba hacia abajo, así que les falta el espíritu de base de las aplicaciones sociales.
...
La Unión Europea está destinando miles de millones de euros a financiar tecnologías d/acc: tecnologías descentralizadas, democráticas y defensivas. [Next Generation Internet](https://www.ngi.eu/) en particular distribuye alrededor de 50 millones de euros para financiar proyectos de software open source.
...
Después ejecutamos un algoritmo de aprendizaje automático basado en [Polis](https://pol.is/), una herramienta de deliberación desarrollada por el [Computational Democracy Project](https://compdemocracy.org/) y ampliamente utilizada en tecnología cívica.
...
Por ahora admitimos [ZK Passport de Rarimo](https://rarimo.com/) y [Zupass](https://zupass.org/). Los usuarios de Rarimo pueden probar de forma anónima cosas como su ciudadanía o grupo de edad sin revelarnos datos personales.
...
En septiembre, Agora fue usado en Francia por un equipo de expertos en facilitación durante la huelga nacional [#bloquonstout](https://www.agoracitizen.network/resources/bloquonstout), que literalmente se traduce como "bloqueemos todo".
...
Estoy segura de que muchas personas aquí están de acuerdo, especialmente la gente cripto. Pero este consenso también reflejaba una encuesta oficial en Francia que mostraba apoyo transpartidista al [impuesto Zucman](https://www.agoracitizen.network/resources/bloquonstout). El impuesto propone un gravamen del 2 % sobre patrimonios superiores a 100 millones de euros, lo que afecta a unas 1.000 familias en Francia.
...
**Palabras clave:** Agora Citizen Network, Devconnect Argentina 2025, deliberación digital, encontrar puntos en común a gran escala, síntesis colectiva, plaza pública digital, mapeo de opiniones, Polis, pruebas de conocimiento cero, identidad descentralizada, Zupass, ZK Passport, tecnología cívica, innovación democrática, #bloquonstout, impuesto Zucman, d/acc.
