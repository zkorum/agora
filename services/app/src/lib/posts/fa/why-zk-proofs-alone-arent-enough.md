...
[اثبات‌های دانش صفر](https://en.wikipedia.org/wiki/Zero-knowledge_proof) اغلب به‌عنوان پاسخ کامل به مسئله حریم خصوصی معرفی می‌شوند. در فناوری مدنی این وعده جذاب‌تر است: یک فرد می‌تواند ثابت کند واجد شرایط مشارکت است، یکتا است، از سنی مشخص بالاتر است یا در یک حوزه قضایی زندگی می‌کند، بدون آنکه محتوای کامل سند هویتی خود را افشا کند.
...
این مقاله از [ارائه‌ای](https://docs.google.com/presentation/d/e/2PACX-1vRKRJW4-ZUHso3o-KzzwemuezH7ifLENCpvJCr9552PlRHzOtyxetsLM-4ghHDwCA/pub?start=false&loop=false&delayms=3000) برای [NGI TrustChain](https://trustchain.ngi.eu/) در سپتامبر 2024 اقتباس شده است. ادعای اصلی ساده است: اثبات‌های دانش صفر یک بلوک مهم برای مشارکت مدنی خصوصی هستند، اما حریم خصوصی کاربر ویژگی کل پشته است.
