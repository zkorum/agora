...
// Apache v2 License
// Adapted from browser.ts to use Node.js crypto instead of window.crypto
...
// Use Node.js crypto instead of window.crypto
// Import directly since k6 supports Node.js built-ins
