# ApiV1SurveyFormFetchPost200ResponseQuestionsInnerAllOfOneOf
...
```typescript
import { ApiV1SurveyFormFetchPost200ResponseQuestionsInnerAllOfOneOf } from './api';

const instance: ApiV1SurveyFormFetchPost200ResponseQuestionsInnerAllOfOneOf = {
    questionSlugId,
    questionText,
    isRequired,
    displayOrder,
