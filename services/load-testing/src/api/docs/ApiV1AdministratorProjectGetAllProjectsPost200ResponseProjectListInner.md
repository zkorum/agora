# ApiV1AdministratorProjectGetAllProjectsPost200ResponseProjectListInner
...
```typescript
import { ApiV1AdministratorProjectGetAllProjectsPost200ResponseProjectListInner } from './api';

const instance: ApiV1AdministratorProjectGetAllProjectsPost200ResponseProjectListInner = {
    projectSlug,
    projectTitle,
