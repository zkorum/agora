# ApiV1OpinionFetchAnalysisContentByCandidatePost200ResponseOneOfConsensusAgreeInner
...
**clustersStats** | [**Array&lt;ApiV1OpinionFetchAnalysisContentByCandidatePost200ResponseOneOfConsensusAgreeInnerClustersStatsInner&gt;**](ApiV1OpinionFetchAnalysisContentByCandidatePost200ResponseOneOfConsensusAgreeInnerClustersStatsInner.md) |  | [default to undefined]
...
```typescript
import { ApiV1OpinionFetchAnalysisContentByCandidatePost200ResponseOneOfConsensusAgreeInner } from './api';

const instance: ApiV1OpinionFetchAnalysisContentByCandidatePost200ResponseOneOfConsensusAgreeInner = {
    opinionSlugId,
    createdAt,
    updatedAt,
    opinion,
