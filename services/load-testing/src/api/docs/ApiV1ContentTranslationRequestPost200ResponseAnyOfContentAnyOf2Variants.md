# ApiV1ContentTranslationRequestPost200ResponseAnyOfContentAnyOf2Variants
...
```typescript
import { ApiV1ContentTranslationRequestPost200ResponseAnyOfContentAnyOf2Variants } from './api';

const instance: ApiV1ContentTranslationRequestPost200ResponseAnyOfContentAnyOf2Variants = {
    original,
    translated,
};
```
