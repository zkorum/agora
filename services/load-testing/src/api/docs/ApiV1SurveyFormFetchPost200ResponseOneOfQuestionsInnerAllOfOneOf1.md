# ApiV1SurveyFormFetchPost200ResponseOneOfQuestionsInnerAllOfOneOf1
...
```typescript
import { ApiV1SurveyFormFetchPost200ResponseOneOfQuestionsInnerAllOfOneOf1 } from './api';

const instance: ApiV1SurveyFormFetchPost200ResponseOneOfQuestionsInnerAllOfOneOf1 = {
    questionSlugId,
    questionText,
    isRequired,
    displayOrder,
