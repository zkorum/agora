# ApiV1SurveyFormFetchPost200ResponseQuestionsInnerOneOf
...
```typescript
import { ApiV1SurveyFormFetchPost200ResponseQuestionsInnerOneOf } from './api';

const instance: ApiV1SurveyFormFetchPost200ResponseQuestionsInnerOneOf = {
    questionSlugId,
    questionText,
    isRequired,
    displayOrder,
