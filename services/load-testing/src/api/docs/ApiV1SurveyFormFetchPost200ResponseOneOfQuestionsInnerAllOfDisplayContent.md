# ApiV1SurveyFormFetchPost200ResponseOneOfQuestionsInnerAllOfDisplayContent
...
```typescript
import { ApiV1SurveyFormFetchPost200ResponseOneOfQuestionsInnerAllOfDisplayContent } from './api';

const instance: ApiV1SurveyFormFetchPost200ResponseOneOfQuestionsInnerAllOfDisplayContent = {
    contentId,
    status,
    mode,
    content,
