...
-- Added cast 
ALTER TABLE "polis_cluster_opinion" ALTER COLUMN "agreement_type" SET DATA TYPE vote_enum_simple USING agreement_type::text::vote_enum_simple;--> statement-breakpoint
