...
ALTER TABLE "conversation" ADD COLUMN "is_indexed" boolean NOT NULL;--> statement-breakpoint
ALTER TABLE "conversation" ADD COLUMN "is_login_required" boolean NOT NULL;--> statement-breakpoint
