...
> = {
    ...
    he: {
        subject: "קוד האימות שלך ב-Agora",
        text: (code) =>
            `קוד האימות שלך הוא ${code}\n\nהזן אותו בהקדם באותו דפדפן/מכשיר שבו השתמשת לבקשת האימות.\n\nאם לא ביקשת את המייל הזה, אין מה לדאוג: אפשר להתעלם ממנו בביטחון.`,
    },
    fa: {
        subject: "کد تأیید شما در Agora",
        text: (code) =>
            `کد تأیید شما ${code} است\n\nآن را در همان مرورگر/دستگاهی که برای درخواست احراز هویت استفاده کردید وارد کنید.\n\nاگر این ایمیل را درخواست نکرده‌اید، نگران نباشید: می‌توانید با خیال راحت آن را نادیده بگیرید.`,
    },
    ky: {
