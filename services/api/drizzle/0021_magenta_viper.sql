CREATE TABLE "user_display_language" (
	...
	CONSTRAINT "user_display_language_user_id_unique" UNIQUE("user_id")
);
...
ALTER TABLE "user_display_language" ADD CONSTRAINT "user_display_language_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "user_display_language_user_idx" ON "user_display_language" USING btree ("user_id");--> statement-breakpoint
