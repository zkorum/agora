...
- `services/analysis-worker-shared`: Shared Python package used by analysis and description workers; receives generated artifacts from `services/shared` and `services/shared-backend`
