...
const fixedCopy: Record<SupportedDisplayLanguageCodes, FixedCopy> = {
    ...
    es: {
        ...
        owner: "Has recibido esta copia operativa para responsables porque tienes autorización para gestionar las Novedades por correo de una organización propietaria de este proyecto. Las preferencias de seguimiento por correo de los participantes no desactivan las copias operativas para responsables.",
        why: "Has recibido esta novedad porque elegiste seguir por correo una conversación en la que participaste.",
        conversations: "Conversaciones incluidas",
        unsubscribeProject: "Dejar de seguir el proyecto por correo",
        unsubscribeConversation: "Dejar de seguir la conversación por correo",
        manage: "Gestionar tus preferencias de seguimiento por correo o dejar de seguir conversaciones concretas",
        report: "Denunciar esta novedad",
        reply: "Responde a este correo para contactar con el equipo del proyecto.",
    },
    fr: {
        test: "E-MAIL DE TEST - aucune action destinée aux participants n'est active",
        owner: "Vous recevez cette copie opérationnelle destinée aux responsables car vous êtes autorisé à gérer les Nouvelles par e-mail pour une organisation propriétaire de ce projet. Les préférences de suivi par e-mail des participants ne désactivent pas les copies opérationnelles destinées aux responsables.",
        why: "Vous recevez cette nouvelle car vous avez choisi de suivre par e-mail une conversation à laquelle vous avez participé.",
        conversations: "Conversations incluses",
        unsubscribeProject: "Ne plus suivre le projet par e-mail",
        unsubscribeConversation: "Ne plus suivre la conversation par e-mail",
        manage: "Gérer vos préférences de suivi par e-mail ou ne plus suivre certaines conversations",
