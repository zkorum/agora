...
> = {
  ...
  es: {
    ...
    integerHelpBetween: "Ingrese un número entero entre {min} y {max}.",
    integerHelpAtLeast: "Ingrese un número entero de al menos {min}.",
    ageGroupPrompt: "¿Cuál es su grupo de edad?",
    sexAtBirthPrompt: "¿Qué sexo se le asignó al nacer?",
    genderPrompt: "¿Cuál es su género actual?",
