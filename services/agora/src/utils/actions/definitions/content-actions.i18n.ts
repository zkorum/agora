...
> = {
  ...
  fa: {
    ...
    cancel: "لغو",
    confirm: "تأیید",
    confirmDeletePost: "آیا مطمئنید که می‌خواهید این گفتگو را حذف کنید؟",
    confirmDeleteComment: "آیا مطمئنید که می‌خواهید این نظر را حذف کنید؟",
    confirmMuteUser:
  ...
  ky: {
    ...
    userReports: "Колдонуучу кабарлоолору",
    share: "Бөлүшүү",
    ...
    confirmDeleteComment: "Бул пикирди жок кылганыңызга ишенесизби?",
    confirmMuteUser:
      "Бул колдонуучуну тындырганыңызга ишенесизби? Анын талкууларын жана пикирлерин көрбөй каласыз.",
    confirmGenericAction: "Бул аракетти аткарганыңызга ишенесизби?",
  },
  ru: {
    report: "Пожаловаться",
    ...
    confirmDeleteComment: "Вы уверены, что хотите удалить это высказывание?",
    confirmMuteUser:
      "Вы уверены, что хотите заглушить этого пользователя? Вы больше не будете видеть его обсуждения и высказывания.",
    confirmGenericAction: "Вы уверены, что хотите выполнить это действие?",
  },
};
