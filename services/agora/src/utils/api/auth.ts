...
import type { Auth409 } from "src/shared/types/dto";
    ...
    try {
      ...
      if (axios.isAxiosError(e)) {
        if (e.response?.status === 409) {
          const auth409: Auth409 = e.response.data as Auth409; // WARNING: this is not automatically generated by OpenAPI - modify this if changing backend service
          switch (auth409.reason) {
            ...
            case "associated_with_another_user":
              // This did:key belongs to another phone number.
