...
> = {
  ...
  fa: {
    ...
    openOpinion: "باز کردن گزاره",
    noReportsAvailable: "هیچ گزارشی برای این {type} موجود نیست.",
    conversation: "گفتگو",
    opinion: "گزاره",
    id: "شناسه:",
    username: "نام کاربری:",
    ...
    invalidSlugIdParam: "پارامتر شناسه slug نامعتبر",
    unknownReportType: "نوع گزارش ناشناخته",
  },
  he: {
    userReportsViewer: "מציג דיווחי משתמשים",
    openConversation: "פתיחת שיחה",
    openOpinion: "פתיחת הצהרה",
    noReportsAvailable: "אין דיווחים זמינים עבור {type} זה.",
    conversation: "שיחה",
    opinion: "הצהרה",
    id: "מזהה:",
    username: "שם משתמש:",
    ...
    invalidReportType: "סוג דיווח לא תקין",
    invalidSlugIdParam: "פרמטר slug ID לא תקין",
    unknownReportType: "סוג דיווח לא ידוע",
  },
  fr: {
  ...
  "zh-Hant": {
    ...
    explanation: "說明 :",
    notAvailable: "不適用",
    invalidReportType: "無效的報告類型",
    invalidSlugIdParam: "無效的 slug ID 參數",
  ...
  ky: {
    ...
    openOpinion: "Пикирди ачуу",
    noReportsAvailable: "Бул {type} үчүн кабарлоолор жок.",
    conversation: "Талкуу",
    opinion: "Пикир",
    id: "ID:",
    ...
    notAvailable: "жок",
    invalidReportType: "Жараксыз кабарлоо түрү",
    invalidSlugIdParam: "Жараксыз slug ID параметри",
    unknownReportType: "Белгисиз кабарлоо түрү",
  },
  ru: {
    userReportsViewer: "Просмотр жалоб пользователей",
    openConversation: "Открыть обсуждение",
    openOpinion: "Открыть высказывание",
    noReportsAvailable: "Для этого {type} нет жалоб.",
    conversation: "Обсуждение",
    opinion: "Высказывание",
    id: "ID:",
    ...
    notAvailable: "н/д",
    invalidReportType: "Недопустимый тип жалобы",
    invalidSlugIdParam: "Недопустимый параметр slug ID",
    unknownReportType: "Неизвестный тип жалобы",
  },
};
