export interface EmailUpdateUnsubscribeTranslations {
  pageTitle: string;
  loading: string;
...
export const emailUpdateUnsubscribeTranslations = {
  en: {
    pageTitle: "Unsubscribe from Email Updates",
    loading: "Loading Email Updates settings",
  ...
  "zh-Hant": {
    ...
    successTitle: "已取消訂閱",
    successDescription: "您將不再收到這些電子郵件更新。",
  },
  "zh-Hans": {
    pageTitle: "取消订阅电子邮件更新",
    loading: "正在加载电子邮件更新设置",
    ...
    successTitle: "已取消订阅",
    successDescription: "您将不再收到这些电子邮件更新。",
  },
  ja: {
    pageTitle: "メール更新の配信停止",
    ...
    successDescription: "今後、これらのメール更新は届きません。",
  },
  ar: {
    pageTitle: "إلغاء الاشتراك في تحديثات البريد الإلكتروني",
    loading: "جارٍ تحميل إعدادات تحديثات البريد الإلكتروني",
    ...
    successDescription: "لن تتلقى تحديثات البريد الإلكتروني هذه بعد الآن.",
  },
  fa: {
    pageTitle: "لغو دریافت به‌روزرسانی‌های ایمیلی",
    ...
    successTitle: "دریافت لغو شد",
    successDescription:
      "دیگر این به‌روزرسانی‌های ایمیلی را دریافت نخواهید کرد.",
  },
  he: {
    pageTitle: "ביטול הרשמה לעדכוני דוא״ל",
    loading: "הגדרות עדכוני הדוא״ל נטענות",
    ...
    successTitle: "ההרשמה בוטלה",
    successDescription: "לא יישלחו אליכם עוד עדכוני הדוא״ל האלה.",
  },
  ky: {
    pageTitle: "Электрондук жаңыртууларга жазылуудан баш тартуу",
    ...
    successTitle: "Сиз жазылуудан чыктыңыз",
    successDescription: "Мындан ары бул электрондук жаңыртууларды албайсыз.",
  },
  ru: {
    pageTitle: "Отписка от почтовых обновлений",
    ...
    successDescription: "Вы больше не будете получать эти почтовые обновления.",
  },
} satisfies Record<string, EmailUpdateUnsubscribeTranslations>;
