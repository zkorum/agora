...
> = {
  ...
  fa: {
    ...
    exportCancelled: "خروجی گفتگوی شما لغو شد",
    importStarted: "واردسازی گفتگوی شما شروع شد",
    importCompleted: "واردسازی گفتگوی شما کامل شد",
    importFailed: "واردسازی گفتگوی شما ناموفق بود",
