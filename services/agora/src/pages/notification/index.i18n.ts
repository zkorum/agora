...
> = {
  ...
  ar: {
    ...
    seedOnePersonVoted: "شخص واحد صوت على مقترح أولي:",
    seedPeopleVoted: "{count} أشخاص صوتوا على مقترح أولي:",
  ...
  es: {
    ...
    seedOnePersonVoted: "1 persona votó en una proposición inicial:",
    seedPeopleVoted: "{count} personas votaron en una proposición inicial:",
  ...
  fa: {
    ...
    noNotifications: "شما هیچ اعلانی ندارید",
    errorTitle: "مشکلی پیش آمد",
    retryButton: "تلاش مجدد",
    contributedOpinion: "{username} یک گزاره به گفتگوی شما اضافه کرد:",
    onePersonVoted: "۱ نفر به گزاره شما رأی داد:",
    peopleVoted: "{count} نفر به گزاره شما رأی دادند:",
    seedOnePersonVoted: "۱ نفر به گزاره اولیه رأی داد:",
    seedPeopleVoted: "{count} نفر به گزاره اولیه رأی دادند:",
    ...
    importStarted: "وارد کردن گفتگوی شما شروع شد",
    importCompleted: "وارد کردن گفتگوی شما تکمیل شد",
    importFailed: "وارد کردن گفتگوی شما ناموفق بود",
    failureReasonProcessingError: "خطای پردازشی رخ داد",
    failureReasonTimeout: "عملیات به پایان رسید",
    failureReasonInvalidDataFormat: "فرمت داده‌ها نامعتبر بود",
  },
  he: {
    notifications: "התראות",
    endOfFeed: "סוף פיד ההתראות",
    noNotifications: "אין לכם התראות",
    errorTitle: "משהו השתבש",
    retryButton: "נסה שוב",
    contributedOpinion: "{username} תרם/ה הצהרה לשיחה שלכם:",
    onePersonVoted: "אדם 1 הצביע על ההצהרה שלכם:",
    peopleVoted: "{count} אנשים הצביעו על ההצהרה שלכם:",
    seedOnePersonVoted: "אדם 1 הצביע על הצהרה ראשונית:",
    seedPeopleVoted: "{count} אנשים הצביעו על הצהרה ראשונית:",
    exportStarted: "ייצוא השיחה שלכם התחיל",
    exportCompleted: "ייצוא השיחה שלכם מוכן",
    exportFailed: "ייצוא השיחה שלכם נכשל",
    exportCancelled: "ייצוא השיחה שלכם בוטל",
    importStarted: "ייבוא השיחה שלכם התחיל",
    importCompleted: "ייבוא השיחה שלכם הושלם",
    importFailed: "ייבוא השיחה שלכם נכשל",
    failureReasonProcessingError: "אירעה שגיאת עיבוד",
    failureReasonTimeout: "הפעולה חרגה מהזמן המוקצב",
    failureReasonInvalidDataFormat: "פורמט הנתונים אינו תקין",
  },
  fr: {
    notifications: "Notifications",
    ...
    seedPeopleVoted:
      "{count} personnes ont voté sur une proposition initiale :",
  ...
  "zh-Hans": {
    ...
    seedOnePersonVoted: "1 人对初始意见投票：",
    seedPeopleVoted: "{count} 人对初始意见投票：",
  ...
  "zh-Hant": {
    ...
    seedOnePersonVoted: "1 人對初始意見投票：",
    seedPeopleVoted: "{count} 人對初始意見投票：",
  ...
  ja: {
    ...
    seedOnePersonVoted: "1人が初期の意見に投票しました：",
    seedPeopleVoted: "{count} 人が初期の意見に投票しました：",
  ...
  ky: {
    ...
    contributedOpinion: "{username} сиздин талкууга пикир кошту:",
  ...
  ru: {
    ...
    contributedOpinion: "{username} добавил высказывание в ваше обсуждение:",
    onePersonVoted: "1 человек проголосовал по вашему высказыванию:",
    peopleVoted: "По вашему высказыванию проголосовали участники ({count}):",
    seedOnePersonVoted: "1 человек проголосовал по начальному высказыванию:",
    seedPeopleVoted:
      "По начальному высказыванию проголосовали участники ({count}):",
