...
> = {
  ...
  fa: {
    ...
    spokenLanguagesLabel: "زبان‌های گفتاری",
    displayLanguageTitle: "زبان نمایش",
    displayLanguageDescription:
      "زبان مورد نظر شما برای سرصفحه‌ها، دکمه‌ها و سایر متون برنامه آگورا",
    additionalLanguagesTitle: "زبان‌های اضافی",
    additionalLanguagesDescription: "برای محتوایی که می‌خواهید در آگورا ببینید",
  ...
  he: {
    pageTitle: "שפה",
    displayLanguageLabel: "שפת תצוגה",
    spokenLanguagesLabel: "שפות דיבור",
    displayLanguageTitle: "שפת תצוגה",
    displayLanguageDescription:
      "השפה המועדפת עליכם עבור כותרות, כפתורים וטקסטים אחרים באפליקציית Agora",
    additionalLanguagesTitle: "שפות נוספות",
    additionalLanguagesDescription: "עבור תוכן שברצונכם לראות ב-Agora",
    englishFallback: "אנגלית",
  ...
  ky: {
    ...
    spokenLanguagesLabel: "Сүйлөгөн тилдер",
    displayLanguageTitle: "Көрсөтүү тили",
    displayLanguageDescription:
      "Agora тиркемесинин башкы сөздөрү, баскычтары жана башка тексттери үчүн каалаган тилиңиз",
    additionalLanguagesTitle: "Кошумча тилдер",
    additionalLanguagesDescription: "Agora'да көргүңүз келген мазмун тилдери",
    englishFallback: "Англис тили",
    noneSelected: "Тандалган жок",
    and: "жана",
    other: "башка",
    others: "башкалар",
  },
  ru: {
    pageTitle: "Язык",
    displayLanguageLabel: "Язык интерфейса",
    spokenLanguagesLabel: "Языки общения",
    displayLanguageTitle: "Язык интерфейса",
    displayLanguageDescription:
      "Предпочитаемый язык для заголовков, кнопок и других элементов приложения Agora",
    additionalLanguagesTitle: "Дополнительные языки",
    additionalLanguagesDescription: "Языки контента, который вы хотите видеть в Agora",
    englishFallback: "Английский",
