...
export interface ConversationUpdatesNewConversationTranslations {
...
const en: ConversationUpdatesNewConversationTranslations = {
  accountPartialReach:
  ...
  emailVerificationEnabled:
    "Email verification and Email Updates are on.",
...
export const conversationUpdatesNewConversationTranslations: Record<
...
> = {
  ...
  ar: {
    ...
    emailVerificationEnabled:
      "تم تفعيل التحقق بالبريد الإلكتروني وتحديثات البريد الإلكتروني.",
  ...
  es: {
    ...
    emailVerificationEnabled:
      "La verificación por correo y las actualizaciones están activadas.",
  ...
  fa: {
    ...
    emailVerificationEnabled:
      "تأیید ایمیل و به‌روزرسانی‌های ایمیلی روشن هستند.",
  ...
  fr: {
    ...
    emailVerificationEnabled:
      "La vérification par e-mail et les mises à jour sont activées.",
  ...
  he: {
    ...
    emailVerificationEnabled: "אימות דוא״ל ועדכוני דוא״ל מופעלים.",
  ...
  ja: {
    ...
    emailVerificationEnabled: "メール確認とメール更新がオンになりました。",
  ...
  ky: {
    ...
    emailVerificationEnabled:
      "Электрондук даректи ырастоо жана жаңыртуулар күйгүзүлдү.",
    enforceEmailVerificationOnly:
    ...
    partialReachTitle:
      "Катышуучулардын көбү жаңыртууларды албай калышы мүмкүн",
    strongVerificationPartialReach:
  ...
  ru: {
    ...
    emailVerificationEnabled:
      "Подтверждение почты и почтовые обновления включены.",
    enforceEmailVerificationOnly:
    ...
    partialReachTitle:
      "Большинство участников могут не получить обновления",
    strongVerificationPartialReach:
  ...
  "zh-Hans": {
    ...
    emailVerificationEnabled: "电子邮件验证和电子邮件更新已开启。",
  ...
  "zh-Hant": {
    ...
    emailVerificationEnabled: "電子郵件驗證和電子郵件更新已開啟。",
