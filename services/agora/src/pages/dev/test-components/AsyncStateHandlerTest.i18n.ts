...
> = {
  ...
  fa: {
    ...
    asyncStateHandlerDescription:
      "آزمایش کامپوننت AsyncStateHandler با وضعیت‌های مختلف غیرهمزمان، سفارشی‌سازی‌ها و بازنویسی اسلات‌ها برای مشاهده نحوه مدیریت وضعیت‌های بارگذاری، خطا، خالی و موفقیت.",
    ...
    sampleData: "داده‌های نمونه با موفقیت بارگذاری شدند!",
    customErrorMessage: "عنوان خطای سفارشی",
    customLoadingText: "پیام بارگذاری سفارشی",
    customEmptyText: "پیام وضعیت خالی سفارشی",
    customRetryText: "تلاش مجدد",
  },
  he: {
    asyncStateHandler: "מטפל מצב אסינכרוני",
    asyncStateHandlerDescription:
      "בדיקת רכיב AsyncStateHandler עם מצבים אסינכרוניים שונים, התאמות אישיות ודריסות slots כדי לראות כיצד הוא מטפל במצבי טעינה, שגיאה, ריק והצלחה.",
    simulateLoading: "טעינה",
    simulateError: "שגיאה",
    simulateEmpty: "ריק",
    simulateSuccess: "הצלחה",
    simulateRetrying: "מנסה שוב",
    resetState: "איפוס",
    basicExample: "דוגמה בסיסית",
    configApiExample: "דוגמת API תצורה",
    customRetryExample: "דוגמת ניסיון חוזר מותאם",
    functionEmptyExample: "דוגמת פונקציה ריקה",
    withCustomSlots: "עם slots מותאמים",
    currentState: "מצב נוכחי",
    sampleData: "נתוני דוגמה נטענו בהצלחה!",
    customErrorMessage: "כותרת שגיאה מותאמת",
    customLoadingText: "הודעת טעינה מותאמת",
    customEmptyText: "הודעת מצב ריק מותאמת",
    customRetryText: "נסה שוב",
  },
  fr: {
