...
> = {
  ...
  ky: {
    ...
    asyncStateHandlerDescription:
      "AsyncStateHandler компонентин ар кандай асинхрондук абалдар, ыңгайлаштыруулар жана слот алмаштыруулар менен тестирлеп, жүктөө, ката, бош жана ийгиликтүү абалдарды кантип иштетээрин көрүңүз.",
    simulateLoading: "Жүктөлүүдө",
    simulateError: "Ката",
    simulateEmpty: "Бош",
    simulateSuccess: "Ийгилик",
    simulateRetrying: "Кайра аракет",
    resetState: "Баштапкы абалга келтирүү",
    basicExample: "Негизги мисал",
    configApiExample: "Конфигурация API мисалы",
    customRetryExample: "Ыңгайлаштырылган кайра аракет мисалы",
    functionEmptyExample: "Функция бош абал мисалы",
    withCustomSlots: "Ыңгайлаштырылган слоттор менен",
    currentState: "Учурдагы абал",
    sampleData: "Үлгү маалыматтар ийгиликтүү жүктөлдү!",
    customErrorMessage: "Ыңгайлаштырылган ката аталышы",
    customLoadingText: "Ыңгайлаштырылган жүктөө билдирүүсү",
    customEmptyText: "Ыңгайлаштырылган бош абал билдирүүсү",
    customRetryText: "Кайра аракет кылуу",
  },
  ru: {
    asyncStateHandler: "Обработчик асинхронного состояния",
    asyncStateHandlerDescription:
      "Тестирование компонента AsyncStateHandler с различными асинхронными состояниями, настройками и переопределениями слотов для проверки обработки загрузки, ошибок, пустого и успешного состояний.",
    simulateLoading: "Загрузка",
    simulateError: "Ошибка",
    simulateEmpty: "Пусто",
    simulateSuccess: "Успех",
    simulateRetrying: "Повтор",
    resetState: "Сбросить",
    basicExample: "Базовый пример",
    configApiExample: "Пример API конфигурации",
    customRetryExample: "Пример пользовательского повтора",
    functionEmptyExample: "Пример пустого состояния функции",
    withCustomSlots: "С пользовательскими слотами",
    currentState: "Текущее состояние",
    sampleData: "Тестовые данные успешно загружены!",
    customErrorMessage: "Пользовательский заголовок ошибки",
    customLoadingText: "Пользовательское сообщение загрузки",
    customEmptyText: "Пользовательское сообщение пустого состояния",
    customRetryText: "Повторить",
  },
};
