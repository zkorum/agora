...
> = {
  ...
  fa: {
    pageTitle: "حریم خصوصی خود را در اختیار بگیرید",
    description:
    ...
    comeBackAndVerify: "به اینجا برگردید و روی تأیید هویت کلیک کنید",
    scanQrCode: "کد QR را با Rarimo اسکن کنید تا هویت خود را تأیید کنید",
    failedToGenerateLink: "تولید لینک تأیید هویت ناموفق بود",
    loadingVerificationLink: "در حال بارگذاری لینک تأیید هویت",
    openLinkOnMobile: "یا لینک زیر را در مرورگر موبایل خود باز کنید:",
    copy: "کپی",
    waitingForVerification: "در انتظار تأیید هویت...",
    verify: "تأیید هویت",
    ...
    verificationFailed: "تلاش تأیید هویت ناموفق بود. لطفاً دوباره تلاش کنید.",
    passportAlreadyLinked:
      "این پاسپورت قبلاً به حساب Rarimo دیگری متصل شده است. لطفاً پاسپورت دیگری امتحان کنید.",
    unexpectedError: "متأسفیم! خطای غیرمنتظره—صفحه را بارگذاری مجدد کنید",
    credentialAlreadyLinked:
      "این پاسپورت قبلاً به حساب دیگری متصل شده است",
    copiedToClipboard: "لینک در کلیپ‌بورد کپی شد",
    couldNotCopy: "کپی در کلیپ‌بورد ممکن نبود",
  },
  he: {
    pageTitle: "שלטו בפרטיות שלכם",
    description:
    ...
    scanQrCode: "סרקו את קוד ה-QR עם Rarimo לאימות זהותכם",
    failedToGenerateLink: "יצירת קישור האימות נכשלה",
    loadingVerificationLink: "טוען קישור אימות",
    openLinkOnMobile: "או פתחו את הקישור הבא בדפדפן הנייד שלכם:",
    copy: "העתקה",
    ...
    unexpectedError: "אופס! שגיאה לא צפויה—נסו לרענן את הדף",
    credentialAlreadyLinked:
      "דרכון זה כבר מקושר לחשבון אחר",
    copiedToClipboard: "הקישור הועתק ללוח",
    couldNotCopy: "לא ניתן היה להעתיק ללוח",
  },
  fr: {
