...
> = {
  ...
  ky: {
    ...
    description:
      "Поляризация күчөп бара жаткан дүйнөдө Agora негизги коомдук маселелер боюнча жарандык диалогду адамдаштырууга жана поляризацияны азайтууга аракет кылат.",
  },
  ru: {
    pageTitle: "Зачем существует Agora?",
    description:
      "В мире нарастающей поляризации Agora стремится вернуть человечность и снизить поляризацию гражданских диалогов по ключевым общественным вопросам.",
  },
};
