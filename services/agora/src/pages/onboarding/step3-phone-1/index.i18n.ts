...
> = {
  ...
  ar: {
    ...
    credentialAlreadyLinked: "رقم الهاتف هذا مرتبط بالفعل بحساب آخر",
  ...
  fr: {
    ...
    throttled: "Trop de tentatives—veuillez attendre avant de réessayer",
    invalidPhoneNumber:
  ...
  ky: {
    ...
    alreadyHasPhone:
      "Каттоо эсебиңизге телефон номери мурунтан эле байланышкан",
