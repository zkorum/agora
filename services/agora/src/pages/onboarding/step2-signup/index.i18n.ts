...
> = {
  ...
  ky: {
    pageTitle: "Agora жалаң адамдар үчүн болууга умтулат",
    description:
      "Интернет трафигинин жарымынан көбү боттордон келет. Ошондуктан биз колдонуучуларды текшеребиз — сиз дүйнөнү басып алууну пландап жаткан роботтор менен эмес, адамдар менен талкуулайсыз!",
    verifyAnonymously: "Анонимдүү текшерүү",
    verifyWithPhone: "Телефон номерим менен текшерүү",
    useEmail: "Электрондук почтамды колдонгум келет",
  },
  ru: {
    pageTitle: "Agora стремится быть исключительно человеческой",
    description:
      "Более половины интернет-трафика создают боты. Поэтому мы верифицируем пользователей — чтобы вы дискутировали с людьми, а не с роботами, замышляющими мировое господство!",
    verifyAnonymously: "Анонимная верификация",
    verifyWithPhone: "Верифицировать по номеру телефона",
    useEmail: "Предпочитаю использовать электронную почту",
  },
};
