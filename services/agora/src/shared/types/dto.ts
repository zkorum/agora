...
export class Dto {
  ...
  static getUserPollResponseByConversationsResponse = z.array(zodPollResponse);
  ...
  static fetchUserConversationsRequest = z
    ...
    .strict();
  static fetchUserConversationsResponse = z.array(zodExtendedConversationData);
  ...
  static generateVerificationLink200 = z.discriminatedUnion("success", [
    ...
    z.object({
      success: z.literal(false),
      reason: z.enum(["already_logged_in", "associated_with_another_user"]),
    }),
  ]);
