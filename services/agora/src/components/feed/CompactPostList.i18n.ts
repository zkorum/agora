...
> = {
  ...
  es: {
    ...
    emptyStateDescription: "Cree una nueva conversación usando el",
    errorStateTitle: "Algo salió mal",
    networkErrorTitle: "Conexión perdida",
    networkErrorDescription: "Las conversaciones se cargarán cuando vuelva a estar en línea.",
    completedTitle: "Está al día",
    completedDescription: "Ha visto todas las conversaciones nuevas.",
