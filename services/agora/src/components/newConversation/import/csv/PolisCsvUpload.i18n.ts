...
> = {
  ...
  fa: {
    uploadTitle: "واردات از فایل‌های CSV Polis",
    description:
      "سه فایل CSV صادر شده از Polis را بارگذاری کنید. هر فایل را در ناحیه مشخص شده زیر رها کنید.",
    summaryFile: "فایل خلاصه",
    commentsFile: "فایل نظرات",
    votesFile: "فایل رأی‌ها",
    maxFileSize: "حداکثر حجم فایل: {size} مگابایت",
    errorFileTooLarge: "حجم فایل از محدودیت {size} مگابایت بیشتر است",
    errorAllFilesRequired: "هر سه فایل CSV الزامی هستند",
    validationFailed: "اعتبارسنجی ناموفق بود",
    serverError: "امکان اعتبارسنجی فایل‌ها وجود ندارد. لطفاً دوباره تلاش کنید.",
    ...
    dropZoneMainText: "فایل را اینجا رها کنید یا برای مرور کلیک کنید",
    dropZoneSubText: "هر فایل csv.",
    browseFilesButton: "مرور فایل‌ها",
    uploadStatusTitle: "وضعیت بارگذاری",
    summaryDropZoneLabel: "۱. خلاصه CSV",
    commentsDropZoneLabel: "۲. نظرات CSV",
    votesDropZoneLabel: "۳. رأی‌ها CSV",
  ...
  he: {
    uploadTitle: "ייבוא מקבצי CSV של Polis",
    description:
      "העלו את שלושת קבצי ה-CSV שיוצאו מ-Polis. גררו כל קובץ לאזור המיועד לו למטה.",
    summaryFile: "קובץ סיכום",
    commentsFile: "קובץ תגובות",
    votesFile: "קובץ הצבעות",
    maxFileSize: "גודל קובץ מקסימלי: {size}MB",
    errorFileTooLarge: "גודל הקובץ חורג ממגבלת {size}MB",
    errorAllFilesRequired: "נדרשים כל שלושת קבצי ה-CSV",
    validationFailed: "האימות נכשל",
    serverError: "לא ניתן לאמת קבצים. אנא נסו שוב.",
    unknownError: "אימות הקובץ נכשל. אנא בדקו את תבנית הקובץ.",
    noValidationResult: "לא התקבלה תוצאת אימות מהשרת.",
    dropZoneMainText: "גררו קובץ לכאן או לחצו לעיון",
    dropZoneSubText: "כל קובץ csv.",
    browseFilesButton: "עיון בקבצים",
    uploadStatusTitle: "סטטוס העלאה",
    summaryDropZoneLabel: "1. סיכום CSV",
    commentsDropZoneLabel: "2. תגובות CSV",
    votesDropZoneLabel: "3. הצבעות CSV",
    dropOrClickText: "גררו לכאן או לחצו",
  },
  ja: {
