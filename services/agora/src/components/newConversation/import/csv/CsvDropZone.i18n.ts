...
> = {
  ...
  ky: {
    ...
    statusValidating: "Текшерилүүдө",
    statusError: "Ката",
    viewDetails: "Чоо-жайын көрүү",
    remove: "Алып салуу",
    ariaViewDetails: "{fileName} үчүн ката чоо-жайын көрүү",
    ariaRemove: "{fileName} файлын алып салуу",
  },
  ru: {
    ...
    remove: "Удалить",
    ariaViewDetails: "Подробности ошибки для {fileName}",
    ariaRemove: "Удалить файл {fileName}",
  },
};
