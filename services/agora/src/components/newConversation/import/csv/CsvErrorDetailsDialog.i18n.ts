...
> = {
  ...
  ky: {
    ...
    supportTextPrefix: "Бир нерсе туура эмес көрүнсө, ",
    supportLinkText: "Discord",
    supportTextSuffix: " аркылуу биз менен байланышыңыз.",
    copyError: "Катаны көчүрүү",
    errorCopied: "Ката билдирүүсү алмашуу буферине көчүрүлдү",
    close: "Жабуу",
  },
  ru: {
    dialogTitle: "Подробности ошибки",
    helpText: "Пожалуйста, проверьте формат CSV-файла.",
    supportTextPrefix: "Если что-то не так, свяжитесь с нами в ",
    supportLinkText: "Discord",
    supportTextSuffix: " для получения поддержки.",
