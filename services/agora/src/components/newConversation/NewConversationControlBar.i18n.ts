...
> = {
  ...
  ar: {
    ...
    private: "خاص",
    public: "عام",
    aiOn: "الذكاء الاصطناعي قيد التشغيل",
  ...
  fa: {
    ...
    private: "خصوصی",
    public: "عمومی",
    aiOn: "هوش مصنوعی روشن",
    aiOff: "هوش مصنوعی خاموش",
  ...
  fr: {
    ...
    aiOn: "IA activée",
    aiOff: "IA désactivée",
    recommendedDefault: "Défaut recommandé",
  ...
  ru: {
    ...
    aiOn: "AI включен",
    aiOff: "AI выключен",
    recommendedDefault: "Рекомендуемое значение",
