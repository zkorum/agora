...
> = {
  ...
  fr: {
    loadingStatus: "Chargement de l'état de l'export...",
    errorLoadingStatus: "Échec du chargement de l'état de l'export",
    processingMessage:
      "Votre export est en cours de traitement. Cette page se mettra à jour automatiquement.",
    failedMessage:
      "L'export a échoué. Veuillez retourner à la page d'historique des exports et demander un nouvel export.",
    cancelledMessage:
      "Cet export a été annulé. Veuillez retourner à la page d'historique des exports pour demander un nouvel export.",
    expiredMessage:
      "Cet export a expiré et a été automatiquement supprimé.",
    expiredDeletedOn: "Supprimé le",
    ...
    exportInfo: "Informations sur l'Export",
    ...
    deleteConfirmTitle: "Supprimer l'Export",
    deleteConfirmMessage:
      "Êtes-vous sûr de vouloir supprimer cet export ? Cette action ne peut pas être annulée.",
    deleteSuccess: "Export supprimé avec succès",
    deleteError: "Échec de la suppression de l'export",
  ...
  ky: {
    ...
    processingMessage:
      "Экспортуңуз иштетилүүдө. Бул барак автоматтык түрдө жаңыланат.",
    failedMessage:
      "Экспорт ишке ашкан жок. Тарых барагына кайтып, жаңы экспорт сурай аласыз.",
    cancelledMessage:
      "Бул экспорт жокко чыгарылды. Тарых барагына кайтып, жаңы экспорт сурай аласыз.",
    expiredMessage: "Бул экспорттун мөөнөтү бүтүп, автоматтык түрдө өчүрүлдү.",
    expiredDeletedOn: "Өчүрүлгөн күн",
    originalError: "Баштапкы ката",
    originalCancellation: "Жокко чыгаруу себеби",
    requestNewExport: "Жаңы экспорт суроо",
    download: "Жүктөп алуу",
    downloadExpired: "Жүктөп алуу мөөнөтү өттү",
    exportInfo: "Экспорт маалыматы",
    exportId: "Экспорт ID",
    status: "Абал",
    ...
    status_expired: "Мөөнөтү өттү",
    conversationId: "Талкуу ID",
    createdAt: "Түзүлгөн күн",
    totalFiles: "Жалпы файлдар",
    totalSize: "Жалпы көлөм",
    availableFiles: "Жеткиликтүү файлдар",
    fileName: "Файлдын аты",
    fileSize: "Көлөмү",
    recordCount: "Жазуулар",
    urlExpiresAt: "Мөөнөтү",
    errorMessage: "Ката",
    cancellationReason: "Жокко чыгаруу себеби",
    deleteExport: "Экспортту жок кылуу",
    deleteConfirmTitle: "Экспортту жок кылуу",
    deleteConfirmMessage:
      "Бул экспортту жок кылгыңыз келгени аныкбы? Бул аракетти кайтаруу мүмкүн эмес.",
    deleteSuccess: "Экспорт ийгиликтүү жок кылынды",
    deleteError: "Экспортту жок кылуу ишке ашкан жок",
    failureReasonProcessingError: "Иштетүүдө ката кетти",
    failureReasonTimeout: "Операция убактысы бүттү",
  },
  ru: {
    loadingStatus: "Загрузка статуса экспорта...",
    errorLoadingStatus: "Не удалось загрузить статус экспорта",
    processingMessage:
      "Ваш экспорт обрабатывается. Страница обновится автоматически.",
    failedMessage:
      "Экспорт не удался. Вы можете запросить новый экспорт на странице истории.",
    cancelledMessage:
      "Этот экспорт был отменён. Вы можете запросить новый экспорт на странице истории.",
    expiredMessage: "Срок действия этого экспорта истёк, и он был автоматически удалён.",
    expiredDeletedOn: "Удалён",
    originalError: "Исходная ошибка",
    originalCancellation: "Причина отмены",
    requestNewExport: "Запросить новый экспорт",
    download: "Скачать",
    downloadExpired: "Срок скачивания истёк",
    exportInfo: "Информация об экспорте",
    ...
    fileSize: "Размер",
    recordCount: "Записей",
    urlExpiresAt: "Истекает",
    errorMessage: "Ошибка",
    cancellationReason: "Причина отмены",
    deleteExport: "Удалить экспорт",
    deleteConfirmTitle: "Удалить экспорт",
    deleteConfirmMessage:
      "Вы уверены, что хотите удалить этот экспорт? Это действие нельзя отменить.",
    deleteSuccess: "Экспорт успешно удалён",
    deleteError: "Не удалось удалить экспорт",
