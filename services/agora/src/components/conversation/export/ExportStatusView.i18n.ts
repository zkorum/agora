...
> = {
  ...
  fa: {
    loadingStatus: "در حال بارگذاری وضعیت خروجی...",
    errorLoadingStatus: "بارگذاری وضعیت خروجی ناموفق بود",
    processingMessage:
      "Your export is being processed. This page will update automatically.",
    failedMessage:
      "Export failed. You can request a new export from the history page.",
    cancelledMessage:
      "This export was cancelled. You can request a new export from the history page.",
    expiredMessage: "این خروجی منقضی شده و به طور خودکار حذف شده است.",
    expiredDeletedOn: "حذف شده در",
    originalError: "خطای اصلی",
    originalCancellation: "دلیل لغو",
    requestNewExport: "درخواست خروجی جدید",
    download: "دانلود",
    downloadExpired: "دانلود منقضی شده",
    exportInfo: "اطلاعات خروجی",
    exportId: "شناسه خروجی",
    status: "وضعیت",
    ...
    deleteConfirmTitle: "حذف خروجی",
    deleteConfirmMessage:
      "آیا مطمئنید که می‌خواهید این خروجی را حذف کنید؟ این عمل قابل بازگشت نیست.",
    deleteSuccess: "خروجی با موفقیت حذف شد",
