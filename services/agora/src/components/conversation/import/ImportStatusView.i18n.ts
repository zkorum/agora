...
> = {
  ...
  fa: {
    loadingStatus: "در حال بارگذاری وضعیت واردسازی...",
    errorLoadingStatus: "بارگذاری وضعیت واردسازی ناموفق بود",
    importId: "شناسه واردسازی",
    status: "وضعیت",
    ...
    processingMessage:
      "واردسازی شما در حال پردازش است. بسته به حجم داده‌ها، ممکن است چند ثانیه تا چند دقیقه طول بکشد.",
    completedMessage: "واردسازی شما با موفقیت انجام شد!",
    failedMessage: "واردسازی ناموفق بود. لطفاً دوباره تلاش کنید یا با پشتیبانی تماس بگیرید.",
