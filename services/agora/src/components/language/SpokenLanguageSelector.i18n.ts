...
> = {
  ...
  fa: {
    ...
    failedToSaveLanguages: "ذخیره تنظیمات زبان ناموفق بود",
    failedToLoadLanguages: "بارگذاری تنظیمات زبان ناموفق بود",
  },
  fr: {
  ...
  he: {
    selectedLanguages: "שפות נבחרות",
    addMoreLanguages: "הוספת שפות נוספות",
    selectLanguages: "בחירת שפות",
    searchLanguages: "...חיפוש שפות",
    noLanguagesFound: "לא נמצאו שפות",
    allLanguagesSelected: "כל השפות נבחרו",
    cannotRemoveLastLanguage: "יש לבחור לפחות שפה אחת",
    failedToSaveLanguages: "שמירת העדפות השפה נכשלה",
    failedToLoadLanguages: "טעינת העדפות השפה נכשלה",
  },
  ja: {
  ...
  ky: {
    ...
    selectLanguages: "Тилдерди тандоо",
    searchLanguages: "Тилдерди издөө...",
    noLanguagesFound: "Тилдер табылган жок",
    allLanguagesSelected: "Бардык тилдер тандалды",
    cannotRemoveLastLanguage: "Жок дегенде бир тил тандалган болушу керек",
    failedToSaveLanguages: "Тил жөндөөлөрүн сактоо ишке ашкан жок",
    failedToLoadLanguages: "Тил жөндөөлөрүн жүктөө ишке ашкан жок",
  },
  ru: {
    selectedLanguages: "Выбранные языки",
    addMoreLanguages: "Добавить ещё языки",
    selectLanguages: "Выбрать языки",
    searchLanguages: "Поиск языков...",
    noLanguagesFound: "Языки не найдены",
    allLanguagesSelected: "Все языки выбраны",
    cannotRemoveLastLanguage: "Необходимо выбрать хотя бы один язык",
    failedToSaveLanguages: "Не удалось сохранить языковые настройки",
    failedToLoadLanguages: "Не удалось загрузить языковые настройки",
  },
};
