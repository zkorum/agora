...
> = {
  ...
  es: {
    ...
    projectContactTitle: "Contacto del proyecto",
  ...
  fr: {
    ...
    projectContactTitle: "Contact du projet",
  ...
  ja: {
    ...
    partnersTitle: "パートナー",
    projectContactTitle: "プロジェクトの連絡先",
    poweredBy: "提供",
  ...
  ar: {
    ...
    projectContactTitle: "جهة اتصال المشروع",
    poweredBy: "مدعوم من",
  ...
  fa: {
    ...
    partnersTitle: "شرکا",
    projectContactTitle: "تماس پروژه",
  ...
  he: {
    ...
    projectContactTitle: "איש קשר של הפרויקט",
