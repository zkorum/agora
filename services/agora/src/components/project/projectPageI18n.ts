...
> = {
  en: {
    ...
    documentsAccessHint:
      "Participant versions are available to everyone. Facilitator versions are available only to project facilitators.",
    documentParticipantVersion: "Participant version",
    documentOwnerVersion: "Facilitator version",
    viewDocument: "View",
    ...
    ...projectAttributionTranslations.en,
  ...
  es: {
    ...
    documentsAccessHint:
      "Las versiones para participantes están disponibles para todo el mundo. Las versiones para facilitadores están disponibles únicamente para quienes facilitan el proyecto.",
    documentParticipantVersion: "Versión para participantes",
    documentOwnerVersion: "Versión para facilitadores",
    viewDocument: "Ver",
    ...
    documentAccessDenied: "No tiene acceso a este documento.",
    ...
    ...projectAttributionTranslations.es,
  ...
  fr: {
    ...
    documentsAccessHint:
      "Les versions participants sont accessibles à tout le monde. Les versions pour les facilitateurs sont réservées aux facilitateurs du projet.",
    documentParticipantVersion: "Version participants",
    documentOwnerVersion: "Version pour les facilitateurs",
    viewDocument: "Voir",
    ...
    ...projectAttributionTranslations.fr,
    projectContactTitle: "Contact",
  ...
  "zh-Hans": {
    ...
    documentsTitle: "项目文档",
    documentsAccessHint:
      "参与者版本向所有人开放。引导员版本仅供项目引导员使用。",
    documentParticipantVersion: "参与者版本",
    documentOwnerVersion: "引导员版本",
    viewDocument: "查看",
    downloadDocument: "下载",
    reloadDocument: "重新加载",
    closeDocument: "关闭文档",
    ...
    ...projectAttributionTranslations["zh-Hans"],
  ...
  "zh-Hant": {
    ...
    documentsTitle: "專案文件",
    documentsAccessHint:
      "參與者版本向所有人開放。引導員版本僅供專案引導員使用。",
    documentParticipantVersion: "參與者版本",
    documentOwnerVersion: "引導員版本",
    viewDocument: "查看",
    downloadDocument: "下載",
    reloadDocument: "重新載入",
    closeDocument: "關閉文件",
    ...
    ...projectAttributionTranslations["zh-Hant"],
  ...
  ja: {
    ...
    documentsAccessHint:
      "参加者版は誰でも利用できます。ファシリテーター版はプロジェクトのファシリテーターのみ利用できます。",
    documentParticipantVersion: "参加者版",
    documentOwnerVersion: "ファシリテーター版",
    viewDocument: "表示",
    ...
    ...projectAttributionTranslations.ja,
  ...
  ar: {
    ...
    documentsAccessHint:
      "نسخ المشاركين متاحة للجميع. نسخ الميسّرين متاحة لميسّري المشروع فقط.",
    documentParticipantVersion: "نسخة المشاركين",
    documentOwnerVersion: "نسخة الميسّرين",
    viewDocument: "عرض",
    ...
    ...projectAttributionTranslations.ar,
  ...
  fa: {
    ...
    documentsAccessHint:
      "نسخه‌های شرکت‌کنندگان برای همه در دسترس‌اند. نسخه‌های تسهیل‌گران فقط برای تسهیل‌گران پروژه در دسترس‌اند.",
    documentParticipantVersion: "نسخه شرکت‌کنندگان",
    documentOwnerVersion: "نسخه تسهیل‌گران",
    viewDocument: "مشاهده",
    ...
    ...projectAttributionTranslations.fa,
  ...
  he: {
    ...
    documentsAccessHint:
      "גרסאות המשתתפים זמינות לכולם. גרסאות המנחים זמינות רק למנחי הפרויקט.",
    documentParticipantVersion: "גרסה למשתתפים",
    documentOwnerVersion: "גרסה למנחים",
    viewDocument: "הצגה",
    ...
    ...projectAttributionTranslations.he,
  ...
  ky: {
    ...
    documentsAccessHint:
      "Катышуучулар үчүн версиялар баарына жеткиликтүү. Фасилитаторлор үчүн версиялар долбоордун фасилитаторлоруна гана жеткиликтүү.",
    documentParticipantVersion: "Катышуучулар үчүн версия",
    documentOwnerVersion: "Фасилитаторлор үчүн версия",
    viewDocument: "Көрүү",
    ...
    ...projectAttributionTranslations.ky,
  ...
  ru: {
    ...
    documentsAccessHint:
      "Версии для участников доступны всем. Версии для фасилитаторов доступны только фасилитаторам проекта.",
    documentParticipantVersion: "Версия для участников",
    documentOwnerVersion: "Версия для фасилитаторов",
    ...
    ...projectAttributionTranslations.ru,
...
import { projectAttributionTranslations } from "src/shared/branding/projectAttributionTranslations";
