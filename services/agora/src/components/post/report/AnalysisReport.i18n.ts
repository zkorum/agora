...
> = {
  ...
  fa: {
    ...
    agreementsSubtitle: "اجماع بین‌گروهی، نه اکثریت ساده. فقط مهم‌ترین موارد از نظر آماری نمایش داده می‌شوند.",
    disagreementsSubtitle: "اجماع بین‌گروهی، نه اکثریت ساده. فقط مهم‌ترین موارد از نظر آماری نمایش داده می‌شوند.",
    divisiveSubtitle: "گزاره‌هایی که گروه‌های نظر را در برابر یکدیگر قرار می‌دهند. فقط مهم‌ترین موارد از نظر آماری نمایش داده می‌شوند.",
  ...
  he: {
    ...
    agreementsSubtitle: "קונצנזוס בין-קבוצתי, לא רוב פשוט. רק המובהקות ביותר מבחינה סטטיסטית מוצגות.",
    disagreementsSubtitle: "קונצנזוס בין-קבוצתי, לא רוב פשוט. רק המובהקות ביותר מבחינה סטטיסטית מוצגות.",
    divisiveSubtitle: "הצהרות שמפלגות בין קבוצות הדעה. רק המובהקות ביותר מבחינה סטטיסטית מוצגות.",
