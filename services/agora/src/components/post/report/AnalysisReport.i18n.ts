...
> = {
  ...
  "zh-Hans": {
    ...
    agreementsLong: "哪些意见被所有群组认可？",
    disagreementsLong: "哪些意见被所有群组否决？",
    divisiveLong: "什么使参与者在各意见群组之间产生分歧？",
    allStatementsLong: "所有意见",
    ...
    divisiveSubtitle: "使意见群组相互对立的意见。仅先显示统计上最显著的结果。",
    allStatementsSubtitle: "分析中包含的所有意见，按所选报告设置排序。",
    allStatementsOrderLabel: "排序方式",
    noAgreementsMessage: "尚未形成共识。",
    noDisagreementsMessage: "尚未形成共识。",
    noDivisiveMessage: "尚未找到显著的分歧意见。",
    noAllStatementsMessage: "暂时没有可用的意见。",
  ...
  "zh-Hant": {
    ...
    agreementsLong: "哪些意見被所有群組認可？",
    disagreementsLong: "哪些意見被所有群組否決？",
    divisiveLong: "什麼使參與者在各意見群組之間產生分歧？",
    allStatementsLong: "所有意見",
    ...
    divisiveSubtitle: "使意見群組相互對立的意見。僅先顯示統計上最顯著的結果。",
    allStatementsSubtitle: "分析中包含的所有意見，按所選報告設定排序。",
    allStatementsOrderLabel: "排序方式",
    noAgreementsMessage: "尚未形成共識。",
    noDisagreementsMessage: "尚未形成共識。",
    noDivisiveMessage: "尚未找到顯著的分歧意見。",
    noAllStatementsMessage: "目前沒有可用的意見。",
