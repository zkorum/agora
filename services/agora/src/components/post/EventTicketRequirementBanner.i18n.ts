...
> = {
  ...
  ky: {
    ...
    verifyingButton: 'Текшерилүүдө...',
    ticketVerified: '{eventName} билети текшерилди',
    ...
    errorWrongEvent: 'Туура эмес иш-чара билети. {eventName} билети талап кылынат.',
  ...
  ru: {
    ...
    verifyButtonRequirement: 'Требуется билет {eventName}',
    verifyingButton: 'Проверка...',
    ticketVerified: 'Билет {eventName} подтверждён',
    ...
    errorWrongEvent: 'Неправильный билет мероприятия. Требуется билет {eventName}.',
