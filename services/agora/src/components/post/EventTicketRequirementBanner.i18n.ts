...
export interface EventTicketRequirementBannerTranslations {
  ...
  accountMergedSuccessfully: string;
  accountRestoredAndMerged: string;
  eventTicketVerifiedSuccessfully: string;
...
> = {
  en: {
    ...
    accountMergedSuccessfully: 'Account merged successfully',
    accountRestoredAndMerged: 'Welcome back! Your account has been restored and your guest data has been merged 🎉',
    eventTicketVerifiedSuccessfully: 'Event ticket verified successfully',
  ...
  ar: {
    ...
    accountMergedSuccessfully: 'تم دمج الحساب بنجاح',
    accountRestoredAndMerged: 'مرحباً بعودتك! تمت استعادة حسابك وتم دمج بياناتك المؤقتة 🎉',
    eventTicketVerifiedSuccessfully: 'تم التحقق من تذكرة الحدث بنجاح',
  ...
  es: {
    ...
    accountMergedSuccessfully: 'Cuenta fusionada correctamente',
    accountRestoredAndMerged: '¡Bienvenido de nuevo! Su cuenta ha sido restaurada y sus datos de invitado han sido fusionados 🎉',
    eventTicketVerifiedSuccessfully: 'Entrada del evento verificada correctamente',
  ...
  fa: {
    verifyButton: 'تأیید',
    verifyButtonRequirement: 'بلیط {eventName} الزامی است',
    verifyingButton: 'در حال تأیید...',
    ticketVerified: 'بلیط {eventName} تأیید شد',
    accountRestored: 'خوش آمدید! حساب شما بازیابی شد',
    accountMerged: 'موفقیت! حساب‌های شما ادغام شدند',
    accountMergedSuccessfully: 'حساب با موفقیت ادغام شد',
    accountRestoredAndMerged: 'خوش آمدید! حساب شما بازیابی و داده‌های مهمان شما ادغام شدند',
    eventTicketVerifiedSuccessfully: 'بلیط رویداد با موفقیت تأیید شد',
    errorDeserialization: 'قالب اثبات نامعتبر است. لطفاً دوباره تلاش کنید.',
    errorInvalidProof: 'تأیید رمزنگاری ناموفق بود. لطفاً دوباره تلاش کنید.',
    errorInvalidSigner: 'بلیط توسط Zupass امضا نشده است.',
    errorWrongEvent: 'بلیط رویداد اشتباه. بلیط {eventName} الزامی است.',
    errorTicketAlreadyUsed: 'این بلیط قبلاً توسط حساب دیگری تأیید شده است.',
  ...
  fr: {
    ...
    accountMergedSuccessfully: 'Compte fusionné avec succès',
    accountRestoredAndMerged: 'Bon retour ! Votre compte a été restauré et vos données invité ont été fusionnées 🎉',
    eventTicketVerifiedSuccessfully: 'Billet d’événement vérifié avec succès',
  ...
  'zh-Hans': {
    ...
    accountMergedSuccessfully: '账户已成功合并',
    accountRestoredAndMerged: '欢迎回来！您的账户已恢复，访客数据已合并 🎉',
    eventTicketVerifiedSuccessfully: '活动门票验证成功',
  ...
  'zh-Hant': {
    ...
    accountMergedSuccessfully: '帳戶已成功合併',
    accountRestoredAndMerged: '歡迎回來！您的帳戶已恢復，訪客數據已合併 🎉',
    eventTicketVerifiedSuccessfully: '活動門票驗證成功',
  ...
  he: {
    verifyButton: 'אימות',
    verifyButtonRequirement: 'נדרש כרטיס {eventName}',
    verifyingButton: '...מאמת',
    ticketVerified: 'כרטיס {eventName} אומת',
    accountRestored: 'ברוכים השבים! החשבון שלך שוחזר',
    accountMerged: 'הצלחה! החשבונות שלך מוזגו',
    accountMergedSuccessfully: 'החשבון מוזג בהצלחה',
    accountRestoredAndMerged: 'ברוכים השבים! החשבון שלך שוחזר ונתוני האורח מוזגו',
    eventTicketVerifiedSuccessfully: 'כרטיס האירוע אומת בהצלחה',
    errorDeserialization: 'תבנית הוכחה לא תקינה. אנא נסו שוב.',
    errorInvalidProof: 'אימות קריפטוגרפי נכשל. אנא נסו שוב.',
    errorInvalidSigner: 'הכרטיס לא חתום על ידי Zupass.',
    errorWrongEvent: 'כרטיס אירוע שגוי. נדרש כרטיס {eventName}.',
    errorTicketAlreadyUsed: 'כרטיס זה כבר אומת על ידי חשבון אחר.',
    errorUnknown: 'אירעה שגיאה לא ידועה. אנא נסו שוב.',
  },
  ja: {
    verifyButton: '確認',
    ...
    accountMergedSuccessfully: 'アカウントが正常に統合されました',
    accountRestoredAndMerged: 'おかえりなさい！アカウントが復元され、ゲストデータが統合されました 🎉',
    eventTicketVerifiedSuccessfully: 'イベントチケットが正常に検証されました',
  ...
  ky: {
    ...
    accountMergedSuccessfully: 'Аккаунт ийгиликтүү бириктирилди',
    accountRestoredAndMerged: 'Кайтканыңыз менен! Аккаунтуңуз калыбына келтирилди жана конок маалыматтарыңыз бириктирилди 🎉',
    eventTicketVerifiedSuccessfully: 'Иш-чара билети ийгиликтүү текшерилди',
  ...
  ru: {
    ...
    accountMergedSuccessfully: 'Аккаунт успешно объединён',
    accountRestoredAndMerged: 'С возвращением! Ваш аккаунт восстановлен, а гостевые данные объединены 🎉',
    eventTicketVerifiedSuccessfully: 'Билет на мероприятие успешно подтверждён',
