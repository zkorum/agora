...
> = {
  ...
  "zh-Hans": {
    ...
    agreeAriaLabel: "同意此意见。当前同意数：",
    keepVotingToDiscoverGroup: "对至少 {minVotes} 条意见投票以被分配到群组",
  ...
  "zh-Hant": {
    ...
    agreeAriaLabel: "同意此意見。當前同意數：",
    keepVotingToDiscoverGroup: "對至少 {minVotes} 條意見投票以被分配到群組",
