...
> = {
  ...
  fa: {
    ...
    conversationClosed:
      "رأی دادن ممکن نیست زیرا گفتگو توسط نویسنده بسته شده است.",
    closedConversationTooltip:
    ...
    keepVotingToDiscoverGroup: "به رأی دادن ادامه دهید تا گروه خود را کشف کنید",
    keepVotingToRefineAnalysis: "به رأی دادن ادامه دهید تا تحلیل دقیق‌تر شود",
