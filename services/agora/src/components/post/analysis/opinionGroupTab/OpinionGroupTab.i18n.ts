...
> = {
  ...
  ja: {
    groupsTitle: "意見グループ",
    groupsSubtitle: "グループは投票行動に基づいて作成され、言語は考慮されません。その後、AIモデルが各グループの意見を読み取り、名前とサマリーを生成します。",
  ...
  ky: {
    ...
    groupsSubtitle: "Топтор добуш берүү жүрүм-турумуна негизделип, тилге карабастан түзүлөт. Андан кийин AI модели ар бир топтун пикирлерин окуп, ат жана корутунду түзөт.",
  ...
  ru: {
    ...
    groupsSubtitle: "Группы формируются на основе голосования, независимо от языка. Затем модель ИИ анализирует высказывания каждой группы, чтобы сгенерировать название и сводку.",
