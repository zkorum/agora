...
> = {
  ...
  ky: {
    ...
    description1:
      "Консенсус топтору адамдардын пикирлерге «Макулмун», «Макул эмесмин» же «Так билбейм» деп кандай добуш бергенине жараша түзүлөт.",
    description2:
  ...
  ru: {
    ...
    description3:
      "Участники должны проголосовать как минимум по {minVotes} высказываниям, чтобы попасть в группу. Те, кто ещё не достиг этого порога, отображаются без группы.",
  },
};
