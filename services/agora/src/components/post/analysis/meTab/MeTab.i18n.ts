...
export const meTabTranslations: Record<string, MeTabTranslations> = {
  en: {
    ...
    voteToUnlock: "Vote on more opinions to unlock",
  ...
  es: {
    ...
    voteToUnlock: "Vota más opiniones para desbloquear",
  ...
  fr: {
    ...
    voteToUnlock: "Votez sur plus d'opinions pour débloquer",
