...
> = {
  ...
  "zh-Hans": {
    agreementsTitle: "通过",
    agreementsDescription:
      "这些意见获得了每个意见群组的一致认可。\n\n这超越了简单多数：即使大多数个体认可，一个群组的反对——无论其规模多小——就足以排除该意见。\n\n只有反映真正跨群组共识的意见才会出现在这里，而非仅基于多数决定的意见。\n\n仅先显示统计上最显著的意见。",
    disagreementsTitle: "否决",
    disagreementsDescription:
      "这些意见被每个意见群组一致否决。\n\n这超越了简单多数：即使大多数个体否决，一个群组的认可——无论其规模多小——就足以排除该意见。\n\n只有反映真正跨群组共识的意见才会出现在这里，而非仅基于多数决定的意见。\n\n仅先显示统计上最显著的意见。",
  },
  "zh-Hant": {
    agreementsTitle: "通過",
    agreementsDescription:
      "這些意見獲得了每個意見群組的一致認可。\n\n這超越了簡單多數：即使大多數個體認可，一個群組的反對——無論其規模多小——就足以排除該意見。\n\n只有反映真正跨群組共識的意見才會出現在這裡，而非僅基於多數決定的意見。\n\n僅先顯示統計上最顯著的意見。",
    disagreementsTitle: "否決",
    disagreementsDescription:
      "這些意見被每個意見群組一致否決。\n\n這超越了簡單多數：即使大多數個體否決，一個群組的認可——無論其規模多小——就足以排除該意見。\n\n只有反映真正跨群組共識的意見才會出現在這裡，而非僅基於多數決定的意見。\n\n僅先顯示統計上最顯著的意見。",
  },
  he: {
  ...
  ky: {
    ...
    agreementsDescription:
      "Бул пикирлер бардык пикир топтору тарабынан бир добуштан жактырылган.\n\nБул жөнөкөй көпчүлүктөн тышкары: көпчүлүк адамдар жактырса да, бир гана топтун каршылыгы — анын чоңдугуна карабастан — пикирди четтетүүгө жетиштүү.\n\nБул жерде топтор аралык чыныгы консенсусту чагылдырган пикирлер гана көрсөтүлөт, жөн гана көпчүлүк добуш негизинде эмес.\n\nАлгач статистикалык жактан эң маанилүүлөрү көрсөтүлөт.",
    disagreementsTitle: "Четке кагылган",
    disagreementsDescription:
      "Бул пикирлер бардык пикир топтору тарабынан бир добуштан четке кагылган.\n\nБул жөнөкөй көпчүлүктөн тышкары: көпчүлүк адамдар четке кагышса да, бир гана топтун жактыруусу — анын чоңдугуна карабастан — пикирди четтетүүгө жетиштүү.\n\nБул жерде топтор аралык чыныгы консенсусту чагылдырган пикирлер гана көрсөтүлөт, жөн гана көпчүлүк добуш негизинде эмес.\n\nАлгач статистикалык жактан эң маанилүүлөрү көрсөтүлөт.",
  },
  ru: {
    agreementsTitle: "Одобрено",
    agreementsDescription:
      "Эти высказывания единогласно одобрены всеми группами мнений.\n\nЭто выходит за рамки простого большинства: даже если большинство участников одобряет, несогласие одной группы — какой бы малой она ни была — достаточно для исключения высказывания.\n\nЗдесь отображаются только высказывания, отражающие подлинный межгрупповой консенсус, а не основанные только на правиле большинства.\n\nСначала показаны наиболее статистически значимые.",
    disagreementsTitle: "Отклонено",
    disagreementsDescription:
      "Эти высказывания единогласно отклонены всеми группами мнений.\n\nЭто выходит за рамки простого большинства: даже если большинство участников отклоняет, одобрение одной группы — какой бы малой она ни была — достаточно для исключения высказывания.\n\nЗдесь отображаются только высказывания, отражающие подлинный межгрупповой консенсус, а не основанные только на правиле большинства.\n\nСначала показаны наиболее статистически значимые.",
  },
};
