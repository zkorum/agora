...
> = {
  ...
  es: {
    ...
    stepSelectBest: "Seleccione la MÁS importante",
    stepSelectWorst: "Ahora seleccione la MENOS importante",
    ...
    completeMessage: "Su clasificación ha sido guardada. Consúltela en la pestaña de análisis.",
    viewMyRanking: "Ver mi clasificación",
    redoRanking: "Rehacer clasificación",
    redoConfirmTitle: "¿Rehacer clasificación?",
    redoConfirmMessage: "Esto restablecerá todas sus comparaciones. Empezará desde el principio.",
    ...
    savingError: "Error al guardar su clasificación. Inténtelo de nuevo.",
    loadingError: "Error al cargar sus datos de clasificación.",
    cancelSelection: "Cancelar selección",
    undoLastVote: "Deshacer",
    retryButton: "Intentar de nuevo",
    learnMoreTitle: "Cómo funciona",
    learnMoreHow: "Compara declaraciones en grupos de 4, eligiendo la más y menos importante. El sistema elige los grupos según lo que necesita más datos y omite comparaciones redundantes automáticamente.",
    learnMoreWhy: "Este método (Best-Worst Scaling) produce clasificaciones más fiables que las escalas de valoración porque fuerza elecciones entre opciones. Sus votos cuentan inmediatamente.",
    learnMoreScoringLink: "Cómo sus votos se convierten en una clasificación \u2192",
    scoringDetailTitle: "De votos a clasificación",
    scoringDetailPipeline: "Sus elecciones de mejor y peor se convierten en puntuaciones de preferencia mediante un modelo matemático. Estas puntuaciones se combinan con los votos de otros participantes mediante Solidago, un algoritmo de agregación de código abierto que pondera las contribuciones según el nivel de confianza del usuario.",
  ...
  "zh-Hans": {
    ...
    noStatements: "暂无可排名的意见。",
    needMoreStatements: "至少需要2条意见才能排名。",
    ...
    retryButton: "重试",
    learnMoreTitle: "工作原理",
    learnMoreHow: "您在4个一组的意见中比较，选出最重要和最不重要的。系统根据数据需求选择分组，并自动跳过重复比较。",
  ...
  "zh-Hant": {
    ...
    noStatements: "暫無可排名的意見。",
    needMoreStatements: "至少需要2條意見才能排名。",
    ...
    retryButton: "重試",
    learnMoreTitle: "運作方式",
    learnMoreHow: "您在4個一組的意見中比較，選出最重要和最不重要的。系統根據資料需求選擇分組，並自動跳過重複比較。",
