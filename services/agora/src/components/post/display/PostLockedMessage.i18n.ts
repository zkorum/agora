...
> = {
  ...
  ky: {
    ...
    closedMessage:
      "Бул талкуу ээси тарабынан жабылган. Жаңы пикирлерди жана добуштарды жарыялоого болбойт.",
    editButton: "Түзөтүү",
  },
  ru: {
    lockedMessage: "Публикация заблокирована: \"{reason}\". Новые высказывания не могут быть опубликованы.",
    closedMessage:
      "Это обсуждение закрыто владельцем. Новые высказывания и голоса не могут быть опубликованы.",
