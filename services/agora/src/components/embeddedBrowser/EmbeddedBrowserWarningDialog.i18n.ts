...
> = {
  ...
  fa: {
    ...
    titleGeneric: "شما در مرورگر درون‌برنامه‌ای هستید",
    message: "لطفاً برای بهترین تجربه در مرورگر پیش‌فرض باز کنید.",
    showManualInstructions: "یا به صورت دستی امتحان کنید",
    instructionStep1: "روی آیکون منو (⋯ یا ⋮) بزنید",
    instructionStep1iOS:
      "Tap the compass icon at the bottom-right corner to open in your default browser",
    instructionStep2: 'Select "Open in Browser" or similar option',
    instructionStep3: "یا آدرس زیر را کپی کرده و در مرورگر خود بچسبانید",
    ...
    urlCopiedNotification: "آدرس در کلیپ‌بورد کپی شد",
