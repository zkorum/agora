...
> = {
  ...
  ky: {
    titleOnboardingRequired: "Continue through onboarding",
    ...
    messageOnboardingRequired:
      "Your intention will be remembered. Before you can participate, you need to go through this conversation's onboarding first. After the welcome step, we'll guide you through any required account verification, ticket verification, and survey steps.",
