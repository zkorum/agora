# ApiV1ContentTranslationRequestPost200ResponseAnyOf1ContentAnyOf2Variants
...
```typescript
import { ApiV1ContentTranslationRequestPost200ResponseAnyOf1ContentAnyOf2Variants } from './api';

const instance: ApiV1ContentTranslationRequestPost200ResponseAnyOf1ContentAnyOf2Variants = {
    original,
    translated,
};
```
