# ApiV1ContentTranslationRequestPost200ResponseAnyOf2
...
```typescript
import { ApiV1ContentTranslationRequestPost200ResponseAnyOf2 } from './api';

const instance: ApiV1ContentTranslationRequestPost200ResponseAnyOf2 = {
    success,
    subject,
    content,
};
