# ApiV1SurveyFormFetchPost200ResponseQuestionsInnerOneOf2
...
```typescript
import { ApiV1SurveyFormFetchPost200ResponseQuestionsInnerOneOf2 } from './api';

const instance: ApiV1SurveyFormFetchPost200ResponseQuestionsInnerOneOf2 = {
    questionSlugId,
    questionText,
    isRequired,
    displayOrder,
