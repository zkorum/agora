# ApiV1SurveyResultsAggregatedPost200ResponseSuppressedRowsInner
...
**clusterId** | **string** |  | [default to undefined]
**clusterLabel** | **string** |  | [default to undefined]
...
```typescript
import { ApiV1SurveyResultsAggregatedPost200ResponseSuppressedRowsInner } from './api';

const instance: ApiV1SurveyResultsAggregatedPost200ResponseSuppressedRowsInner = {
    scope,
    clusterId,
    clusterLabel,
    questionId,
