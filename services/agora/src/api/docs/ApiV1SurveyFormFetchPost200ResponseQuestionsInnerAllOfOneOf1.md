# ApiV1SurveyFormFetchPost200ResponseQuestionsInnerAllOfOneOf1
...
```typescript
import { ApiV1SurveyFormFetchPost200ResponseQuestionsInnerAllOfOneOf1 } from './api';

const instance: ApiV1SurveyFormFetchPost200ResponseQuestionsInnerAllOfOneOf1 = {
    questionSlugId,
    questionText,
    isRequired,
    displayOrder,
