...
> = {
  ...
  ar: {
    newOpinion: "سيتم استعادة مسودة مقترحك المكتوب عند عودتك.",
    newConversation: "سيتم استعادة مسودة محادثتك المكتوبة عند عودتك.",
    agreement: "ستعود إلى هذا المقترح عند عودتك.",
  ...
  es: {
    ...
    agreement: "Se le devolverá a esta proposición cuando regrese.",
    reportUserContent:
  ...
  fr: {
    ...
    agreement: "Vous serez redirigé vers cette proposition à votre retour.",
    reportUserContent:
  ...
  ky: {
    ...
    newConversation:
      "Жазган талкууңуздун черновиги кайтып келгенде калыбына келтирилет.",
    agreement: "Кайтып келгенде бул пикирге кайтасыз.",
    reportUserContent:
      "Колдонуучу мазмунун кабарлоо үчүн каттоо эсеби талап кылынат.",
    voting: "Кайтып келгенде бул талкууга кайтасыз.",
  },
  ru: {
    newOpinion: "Ваш черновик высказывания будет восстановлен при возвращении.",
    newConversation:
      "Ваш черновик обсуждения будет восстановлен при возвращении.",
    agreement: "Вы вернётесь к этому высказыванию при возвращении.",
    reportUserContent:
      "Для отправки жалобы на контент требуется аккаунт.",
    voting: "Вы вернётесь к этому обсуждению при возвращении.",
  },
};
