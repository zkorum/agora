...
if TYPE_CHECKING:
    ...
    from agora_analysis_worker_shared.config import Settings, SimulationMode
    from agora_analysis_worker_shared.description_input import ConversationDescriptionInput
    from agora_analysis_worker_shared.description_translation import DescriptionForTranslation
